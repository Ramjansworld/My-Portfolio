<template>
    <div class="flex flex-colm relative items-center justify-between mx-2 mt-[10px]">
      ...
      <img src="Walton Web Page.png" alt="image" class="h-[500px] w-[750px]" />
      <div class="bg-white px-[40px] w-[600px]">
        ...
        <p class="font-semibold text-pink-700 text-md">
          This project was about Walton Group's ecommerce webpage design which was developed
          by using Vue3, JavaScript, and Vite dev tools. For desiging I uesd Tailwind.css
          postcss plugins. Within Vue3 I used Vue-router(Dynamic routing, Nested routing,
    ...
    <div class="flex flex-colm items-center justify-between mx-2 mt-[10px]">
      <div class="bg-white px-[40px] w-[600px]">
        <h1 class="font-serif text-3xl font-bold text-blue-500">Project Description</h1>
        <p class="font-semibold text-pink-700 text-md">
          This project was about vehicle servicing oneline e-commerce platform in
          Bangladesh. For developing and designing this website I used Vue.js(Vue3),
    ...
    <div>
      <a href="#">
        <img src="Vehicle Servicing BD.png" alt="image" class="h-[500px] w-[750px]" />
      </a>
    </div>
  </div>
    <div class="flex flex-colm relative items-center justify-between mx-2 mt-[10px]">
      <img src="Vet Pet Master.png" alt="image" class="h-[500px] w-[750px]" />
      <div class="bg-white px-[40px] w-[600px]">
        <h1 class="font-serif text-3xl font-bold text-blue-500">Project Description</h1>
        <p class="font-semibold text-pink-700 text-md">
          This project was about online veterinary services platform from where you can take
          different kinds of veterinary services like Telemidicine service, E-prescription
          service, Veterinary consultancy, Buying Pet foods and toys, Buying Pet animals
          medicine etc. For developing and designing this website I used Vue.js(Vue3),
          JavaScript, and Tailwind.css postcss plugins. For super fast SEO I chosed Vite.js
          DevTools.
        </p>
    ...
    <div class="flex flex-colm relative items-center justify-between mx-2 mt-[10px]">
      ...
      <a href="#">
        <img
          src="Lamborghini Huracan Tacnica.png"
          alt="image"
